    ...
    <div class="col-12 col-md-8">
        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <form action="{{ route('save.database') }}" method="POST">
                    @csrf
                    ...
                    <div class="mb-3">
                        ...
                        <input type="number" name="db_port" id="db_port" required
                            class="form-control{{ $errors->has('db_port') ? ' is-invalid' : '' }}" placeholder="3306"
                    ...
                    <div class="mb-3">
                        <label for="db_pass">
                            @lang('setup.database.db_pass')
                        </label>
                        <input type="password" name="db_pass" id="db_pass"
                            class="form-control{{ $errors->has('db_pass') ? ' is-invalid' : '' }}"
